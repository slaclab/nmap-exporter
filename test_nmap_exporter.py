...
# hthttp://localhost:9115/probe?target=google.com&module=http_2xx tps://github.com/prometheus/blackbox_exporter?tab=readme-ov-file
"""
docker run --rm   -p 9115:9115   --name blackbox_exporter   -v $(pwd):/config   quay.io/prometheus/blackbox-exporter:latest 
"""
